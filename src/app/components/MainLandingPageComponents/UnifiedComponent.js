...
export default function UnifiedComponent({ title, generalResponses, funResponses, serviceKeywords }) {
    ...
    const pageData = [
        { title: "about", name: "About Us", description: "About Us In this section you will hear all about us and what we do. You can ask more questions if you have any." },
        { title: "blogs", name: "Blogs", description: "Blogs In this section you can learn about the services that we provide. Ask any questions if you have any!" },
        { title: "innovation", name: "Innovation and Insights", description: "Innovation Insights In this section you can learn about the services that we provide. Ask any questions if you have any!" },
        { title: "services", name: "Services", description: "Services In this section you can learn about the services that we provide. Ask any questions if you have any!" },
        { title: "industry", name: "industry-vertical", description: "industry-vertical In this section you can learn about the services that we provide. Ask any questions if you have any!" },
    ];
    const getPageData = (pageTitle) => {
        return pageData.find(page => page.title === pageTitle) || { title: "notitle", name: "Page Not Found", description: "No description available." };
    };
                    ...
                    {Object.keys(questionsAndResponses).length > 0 ? (
                        Object.keys(questionsAndResponses).map((question, index) => (
                            <button
                                ...
                                className={`px-4 py-2 border max-w-[15rem] text-gray-800 text-[14px] rounded-full shadow ${isThinking

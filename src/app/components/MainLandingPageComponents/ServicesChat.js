    ...
    return (
        <>
            ...
            <aside className="w-1/4 bg-white mr-16 p-4 border-r h-full overflow-y-auto custom-scrollbar hidden lg:block">
                <h2 className="titleTextLG text-center m-5">What We Do</h2>
                <OurServices />
                {/* <ChatList selectedCategory="services" /> */}
            </aside>
        </>
    );
}

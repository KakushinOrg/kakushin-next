...
export default function MainLandingPage() {
    ...
    const findClosestMatch = (input) => {
        ...
        const randomResponse = Math.random() > 0.5 ? getRandomResponse(generalResponses) : getRandomResponse(funResponses);
